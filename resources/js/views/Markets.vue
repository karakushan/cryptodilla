<template>
    <main class="cs--page cs--dashboard--markets">
        <div class="cs--container">
            <ul class="cs--dashboard-tab-list">
                <li class="cs--dashboard-tab-item cs--dashboard-tab-item--active">
                    <a href="javascript:void(0)">Dashboard</a>
                </li>

                <li class="cs--dashboard-tab-item">
                    <a href="javascript:void(0)">Portfoilo</a>
                </li>
            ...
            <div class="cs--page__head">
                <h1 class="cs--page__title">Market Overview</h1>
